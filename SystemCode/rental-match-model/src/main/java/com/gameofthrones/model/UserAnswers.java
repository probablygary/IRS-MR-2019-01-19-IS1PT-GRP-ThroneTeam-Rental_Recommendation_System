...
public class UserAnswers {
	...
	public String toString() {
		return "UserAnsSearch [qnsBudget=" + qnsBudget + ", qnsPurpose=" + qnsPurpose + ", qnsLocationWork="
				...
				+ ", furnished=" + furnished + ", getQnsBudget()=" + getQnsBudget() + ", getQnsPurpose()="
				+ getQnsPurpose() + ", getQnsLocationWork()=" + getQnsLocationWork() + ", getQnsStayingFamily()="
				+ getQnsStayingFamily() + ", getQnsNoOfChild()=" + getQnsNoOfChild() + ", getQnsNoOfAdult()="
				+ getQnsNoOfAdult() + ", getQnsSpouseWork()=" + getQnsSpouseWork() + ", getQnsCook()=" + getQnsCook()
				+ ", getQnsTransport()=" + getQnsTransport() + ", getQnsExercise()=" + getQnsExercise()
				+ ", getPrice()=" + getPrice() + ", getZone()=" + getZone() + ", getLeaseType()=" + getLeaseType()
				+ ", getNoOfRooms()=" + getNoOfRooms() + ", getSpouseWork()=" + getSpouseWork() + ", getUserWork()="
				+ getUserWork() + ", getChildCare()=" + getChildCare() + ", getGym()=" + getGym() + ", getMarket()="
				+ getMarket() + ", getMrt()=" + getMrt() + ", getBusStop()=" + getBusStop() + ", getSchool()="
				+ getSchool() + ", getFoodCourt()=" + getFoodCourt() + ", getFurnished()=" + getFurnished()
